<%-- 
    Document   : billing
    Created on : Jan 30, 2015, 12:06:31 PM
    Author     : Deeptha
--%>
...
<html>
    ...
    <body>
        ...
        <%            String PaymentOption = "PayPal", PaymentProcessorSelected = "";
            ...
            if (PaymentOption == "PayPal") {
                ...
                /*
                 ...
                 '------------------------------------
                 */
                String returnURL = "localhost:8080/Pickme.lk/Transaction?satus=success";
                ...
                /*
                 ...
                 '------------------------------------
                 */
                String cancelURL = "localhost:8080/Pickme.lk/Transaction?satus=cancel";
