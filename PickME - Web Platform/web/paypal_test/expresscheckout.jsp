...
<%    /*
    ...
    /*
     ...
     '------------------------------------
     */
    String returnURL = "http://localhost:8080/Pickme.lk/confirm.jsp";
    ...
    /*
     ...
     '------------------------------------
     */
    String cancelURL = "http://localhost:8080/Pickme.lk/OrderCanceled.jsp";
    ...
    if (strAck != null && strAck.equalsIgnoreCase("Success")) {
        ...
        out.print(ErrorCode);
        out.print(ErrorShortMsg);
        out.print(ErrorLongMsg);
        out.print(ErrorSeverityCode);
    }
%>