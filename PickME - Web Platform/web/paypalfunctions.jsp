...
<%
    ...
    /*
     ...
     '------------------------------------
     */
    gv_APIUserName = "pickme.lk_api1.gmail.com";
    gv_APIPassword = "PDW8PFHPX5TGMPGY";
    gv_APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A-eBVkfOVmDeCImBLf--P29JfOsa";
...
<%!
    ...
    public HashMap CallShortcutExpressCheckout(String paymentAmount, String currencyCodeType, String paymentType,
        ...
        if (strAck != null && strAck.equalsIgnoreCase("Success")) {
            ...
            System.out.println(nvp.get("TOKEN"));
        }
